  ...
  <div class="container">
    <section>
      ...
      <div class="justify multicolumnparagraph">
        ...
        <p>
          Qui plus est, non seulement l’information est difficile à trouver auprès d’un organe public, mais aussi, dans certains cas, elle n’est pas en adéquation avec les attentes d’un autre. De surcroît, les <b>autorités publiques</b> ne sont pas les seuls interlocuteurs des <b>associations</b>. En effet, les <b>entreprises</b> s’ajoutent à la liste d’intervenants dont il est nécessaire d’assurer la coopération.
        </p>
        <p>
          Dès lors, nous avons voulu créer une structure visant à fournir les <b>clés de compréhension</b> nécessaires au fonctionnement associatif. Par le soutien à l’organisation de manifestations, à la création et à la gestion d’associations, nous voulons permettre au public de s’engager dans le monde associatif afin de collectivement contribuer à l’amélioration de notre société.
        </p>
        <p>
          Nous croyons fortement dans le partage d’expérience et l’entraide. C’est pourquoi nous avons décidé de prendre contact avec plusieurs personnes et autorités dont le domaine d’activité présente un lien avec celui dans lequel nous souhaitons agir. Nous sommes persuadés qu’avec une <b>collaboration</b> étroite entre les acteurs du canton, nous pourrons donner les moyens aux associations d’organiser des manifestations plus facilement pour un résultat plus sécure et de mieux se gérer pour une meilleure plus-value collective.
        </p>
      </div>
    </section>
    <section class="mt-5">
