<template>
  <div style="margin-top: -3rem;">
    <div class="jumbotron jumbotron-fluid jumbotron__home text-white mb-0">
      <div class="container">
    ...
    <div class="bg-light py-5">
      <section class="container">
        ...
        <video width="100%" controls poster="/img/home/lyoxa-presentation.png" @ended="videoHasEnded">
          ...
          Votre navigateur ne supporte pas les vidéos natives.
        </video>
    ...
    <section class="container py-5">
      <h1>Nous soutenir</h1>
      <p class="justify">C’est grâce à vous que nous pouvons agir. Voici quelques moyens de nous soutenir…</p>
      <nuxt-link class="btn btn-primary btn-lg mt-3" to="/nous-soutenir/" role="button">Nous soutenir</nuxt-link>
    </section>
  </div>
</template>
